  ...
  return (
    <div className="bg-white rounded-sm shadow">
      <img 
        ...
        src={`${props.story.content.main_image.filename}/filters:quality(80)`} 
      ...
      <div className="p-8">
        ...
        <p className="text-gray-700 uppercase font-bold mt-2 text-sm tracking-wide">{props.story.content.location}, India</p>
