  ...
  return (
    <div className="bg-sky-950 rounded-lg shadow border-2 border-sky-950">
      ...
      <div className="p-8">
        ...
        <Link className="bg-green-100 px-4 py-2 text-sky-950 max-w-fit rounded-lg font-bold text-base mt-8 block hover:bg-green-400" href={`/${props.story.full_slug}`}>View Tour</Link>
      </div>
    </div>
  );
};