...
function BookingForm() {
  ...
  const tourCity = searchParams.get('city') || "Selected City";
  const tourName = searchParams.get('name') || "Selected Tour";
  ...
  return (
    <main className="container mx-auto p-8 max-w-2xl min-h-[60vh] flex flex-col justify-center">
      {/* SUCCESS STATE: Shown only after bookingId is received */}
      {bookingId ? (
        <div className="text-center animate-in fade-in zoom-in duration-500">
          ...
          <p className="text-gray-600 mb-8">Thank you for choosing us. Your adventure starts soon!</p>
        ...
        /* FORM STATE: Hidden after submission */
        <>
          <h1 className="text-3xl font-bold text-rose-900 mb-6">Complete Your Booking</h1>
          ...
          <div className="bg-rose-50 p-6 rounded-lg mb-8 border border-rose-200">
            ...
            <p className="text-gray-600 font-medium">Price per person: ₹{unitPrice.toLocaleString('en-IN')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-4 border-t flex justify-between items-center text-2xl font-bold text-rose-900">
              <span>Total:</span>
              <span>₹{parseFloat(totalPrice).toLocaleString('en-IN')}</span>
            </div>
            <p className='text-sm text-gray-500 italic mb-4'>* Including 12.5% GST and fees</p>
